    ...
    <div class="app-body">
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('index.php/sp_controller/profile_pengguna/index'); ?>">
                <i class="nav-icon icon-speedometer"></i> Dashboard
              </a>
            </li>
            <li class="nav-title">Menu</li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('index.php/data_diagnosis/index'); ?>">
                    <i class="nav-icon icon-people"></i>Data Diagnosa</a>
                </li>
                 <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('index.php/data_diagnosis/index?tambah=form_tambah'); ?>">
                    <i class="nav-icon icon-pencil"></i>Diagnosa Kerusakan</a>
                </li>
               <li class="nav-item">
