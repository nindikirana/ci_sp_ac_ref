              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <i class="fa fa-edit"></i>FORM TAMBAH DATA KERUSAKAN</div>
                  <div class="card-body">
                    <form class="form-horizontal" action="create" method="post" enctype="multipart/form-data">
                        ...
                        <div class="controls">
                          ...
                          <input type="text" class="form-control" id="appendedInput" name="nama_kerusakan" required>
                       ...
                       <div class="form-group">
                        ...
                        <div class="controls">
                          <div class="input-group">
                              <input class="form-control" size="16" type="file" id="gambar" name="gambar[]" multiple class="form-control" placeholder="Foto kerusakan">
                            <div class="input-group-append">
                            </div>
                          </div>
                        </div>
