              ...
              <div class="col-lg-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <i class="fa fa-align-justify"></i>Tabel Detail Data Kerusakan</div>
                  <div class="card-body">
                    <table class="table table-responsive-sm table-bordered table-striped table-sm">
                      <tbody>
                        <tr>
                        <th align="center">ID KERUSAKAN</th>
                        <td colspan="3" align="center"><?php echo $this->row->id_kerusakan; ?></td>
                        </tr>
                        <tr>
                        <th align="center">NAMA KERUSAKAN</th>
                        <td colspan="3" align="center"><?php echo $this->row->nama_kerusakan; ?></td>
                        </tr>
                        <tr>
                        <!-- <th align="center">SIKLUS kerusakan</th>
