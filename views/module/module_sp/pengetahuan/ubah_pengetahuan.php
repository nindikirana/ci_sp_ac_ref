                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="<?php echo base_url('index.php/data_pengetahuan/update'); ?>" method="post" class="form-horizontal">
                        ...
                        <label class="col-form-label" for="appendedInput">ID KERUSAKAN</label>
                        <div class="controls">
                          <div class="input-group">
                            <input class="form-control" id="appendedInput" size="16" name="id_kerusakan" type="text"value="<?php echo $model->id; ?>" required disabled>
