  ...
  <div class="container-fluid">
          ...
          <input class="form-control" type="text" placeholder="Masukan id atau nama" name="kunci">
                ...
                <form method="post" action="<?php echo base_url('index.php/data_pengetahuan/delete'); ?>">
                    ...
                    <li class="page-item">            
          <input class="form-control" type="text" placeholder="Masukan ID kerusakan" name="id_kerusakan">
                        </li>
                      </ul>
   ...
   <?php
    ...
    ?>
                      <tbody>
                          ...
                          <td>
                            <span class="badge badge-warning"><a href="<?php echo base_url('index.php/data_pengetahuan/detail?id_kerusakan='.$row->id_kerusakan); ?>">Detail</a></span>
                          </td>
                        </tr>
                      </tbody>
     <?php 
