...
public $rows;
	...
	public function create(){
		if(isset($_POST['btnSubmit'])){
			$this->model->id_kerusakan = $_POST['id_kerusakan'];	
	...
	$this->model->validasi = $_POST['id_kerusakan'];
	...
	redirect('data_pengetahuan/index');
	}if($this->model->validasi_delete()==FALSE && $_POST['id_kerusakan']!=null){
	$this->session->set_flashdata('konfirmasi_hapus', 
    '<div class="alert alert-warning alert-dismissible fade show" role="alert">
    <strong>Data Pengetahuan Gagal Dihapus !<br/>
    ID Kerusakan yang dimasukan salah !</strong>
    <button class="close" type="button" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">×</span>
    </button></div>');
	redirect('data_pengetahuan/index');	
    ...
    '<div class="alert alert-warning alert-dismissible fade show" role="alert">
    <strong>Data Pengetahuan Gagal Dihapus !<br/>
    Masukan ID Kerusakan yang Ingin Dihapus !</strong>
    <button class="close" type="button" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">×</span>
    </button></div>');
	redirect('data_pengetahuan/index');	
